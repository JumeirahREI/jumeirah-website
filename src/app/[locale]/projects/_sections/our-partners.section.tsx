...
export default function OurPartnersSection() {
  ...
  return (
    <section className="container px-2 lg:mb-52">
      ...
      <p className="mx-auto my-4 text-center text-sm font-light text-wrap text-[#9C9C9C] md:text-lg lg:mx-32 lg:my-6 lg:text-xl lg:leading-relaxed xl:mx-52 xl:text-2xl 2xl:mx-80">
        {t("description")}
      </p>
