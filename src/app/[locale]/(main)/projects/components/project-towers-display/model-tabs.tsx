...
export default function ModelTabs({
  ...
  return (
    <div className="model-tabs no-scrollbar fade-x overflow-x-hidden px-[var(--padding-x)] py-0.5 md:row-start-1 lg:[--fade-start:6%] ltr:mr-6 rtl:lg:ml-6">
