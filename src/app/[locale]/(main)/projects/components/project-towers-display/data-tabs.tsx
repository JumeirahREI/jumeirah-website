...
export default function DataTabs({
  ...
  return (
    <div className="flex items-center gap-0 px-[var(--padding-x)] py-0.5 xl:gap-6">
      {tabs.map((tab, index) => {
